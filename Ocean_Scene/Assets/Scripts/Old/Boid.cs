...
{
     List<Steering_Behaviour> behaviours = new List<Steering_Behaviour>();
    ...
    void Start()
    {
        ...
        Steering_Behaviour[] behaviours = GetComponents<Steering_Behaviour>();

        foreach (Steering_Behaviour b in behaviours)
        {
