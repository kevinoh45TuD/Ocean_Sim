...
public class fishFlock : MonoBehaviour
{
    ...
    public List<fishFlock> cohesionNeighbours = new List<fishFlock>();
    public List<fishFlock> avoidanceNeighbours = new List<fishFlock>();
    public List<fishFlock> aligementNeighbours = new List<fishFlock>();
    public spawnFish assignedFlock;
    ...
    public void AssignFlock(spawnFish flock)
    {
        assignedFlock = flock;
    }
	...
	private void FindNeighbours()
	{
		...
		var allUnits = assignedFlock.activeFish;
